...
v2.0 가중치 구조 유지 + 아래 조건 추가:

| 조건 | 기준 | 근거 |
|------|------|------|
| 홀짝 균형 | 홀수 2~4개 | 역대 당첨번호 분포 |
| 연속번호 방지 | 연속 3개 이상 제외 | 출현 빈도 극히 낮음 |
| **합계 범위** | 100 ~ 175 | 실제 당첨번호 합계 90% 이상 해당 |
| **구간 분포** | 5구간 중 3구간 이상 | 특정 구간 편중 방지 (1-10 / 11-20 / 21-30 / 31-40 / 41-45) |
| **끝수 균형** | 동일 끝자리 최대 2개 | 끝수 편중 방지 |

최대 50회 재시도 후 조건 충족 번호 반환.
