...
| `/pension/results` | 결과 | 최신 연금복권 회차 결과 카드 · 지난 회차 검색 |
...
회차 결과 화면은 **뷰어 1개 + 목록 1개** 구조다. 뷰어의 좌우 화살표, 목록 헤더의 검색,
목록 행 클릭이 모두 같은 `selected` 회차 하나를 바꾸고, 목록 창은 그 회차를 따라 움직인다
(보는 회차부터 과거로 10개). 1회~최신 전 구간을 넘길 수 있다.
