...
| 경로 | 탭 | 내용 |
|------|----|------|
| `/lotto/results` | 결과 | 최신 당첨 결과 카드 · 최신 결과 동기화 · 회차 탐색 · 최근 회차 히스토리 · 번호 색상 안내 |
| `/lotto/picks` | 추천 | 추천 번호 5세트 생성 · 규칙 우선순위 |
| `/lotto/backtest` | 진단 | 백테스트 규칙 진단 (랜덤 기준선 0.8 비교 · 규칙 가중치 · 규칙별 성과) |
| `/pension/results` | 결과 | 최신 연금복권 회차 결과 카드 · 최신 결과 동기화 · 지난 회차 검색 |
| `/pension/picks` | 추천 | 추천번호 1세트 생성 · 성향 우선순위 |
| `/pension/backtest` | 진단 | 백테스트 성향 진단 |
